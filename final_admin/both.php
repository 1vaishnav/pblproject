...
<div id="layoutSidenav_content">
    ...
    $query = "SELECT * FROM request WHERE repair_type = 'Both_Carpentry_&_Welding_related_work'";
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Both Carpentry & Welding Section</h1>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    Both Carpentry & Welding Section
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="view.php">
                                        ...
                                        style="background-color: #007BFF; color: white; border: none; padding: 8px 16px; font-size: 14px; cursor: pointer; border-radius: 4px; transition: background-color 0.3s;"
