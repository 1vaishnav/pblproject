...
<div id="layoutSidenav_content">
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Status Pending</h1>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="view.php" style="display:inline;">
                                        ...
                                        <button type="submit" class="view-btn" style="background-color: #007BFF; color: white; border: none; padding: 8px 16px; font-size: 14px; cursor: pointer; border-radius: 4px; transition: background-color 0.3s;"
                                            onmouseover="this.style.backgroundColor='#0056b3';" 
                                            onmouseout="this.style.backgroundColor='#007BFF';">View</button>
                                    </form>
                                </td>
                                <td>
                                <div style="display: flex; gap: 10px;">
                                        <form method="POST" action="approved.php">
                                            <input type="hidden" name="entry_id" value="<?php echo $row['id']; ?>">
                                            <button type="submit" style="border: none; background-color: #28a745; color: white; cursor: pointer; display: flex; align-items: center;">
